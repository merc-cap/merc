...
interface PledgingVaultInterface extends ethers.utils.Interface {
  functions: {
    ...
    "gaugeId()": FunctionFragment;
    "increaseAllowance(address,uint256)": FunctionFragment;
    "initialize(address,uint256,address,string,string)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "gaugeId", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "gaugeId", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "increaseAllowance",
    data: BytesLike
  ): Result;
...
export class PledgingVault extends BaseContract {
  ...
  interface: PledgingVaultInterface;
  ...
  functions: {
    ...
    gaugeId(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    gaugeId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
